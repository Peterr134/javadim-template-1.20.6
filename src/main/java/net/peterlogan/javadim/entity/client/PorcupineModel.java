...
import net.peterlogan.javadim.entity.animation.ModAnimations;
...
public class PorcupineModel<T extends JavacupineEntity> extends SinglePartEntityModel<T> {
	...
	@Override
	public void setAngles(JavacupineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
